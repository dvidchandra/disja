...
import Candidates from "../component/dashboard/Candidates";
import JobEmployee from "../component/dashboard/JobEmployee";
import ScheduleActivity from "./dashboard/ScheduleActivity";
    ...
    <div className="sidebar">
      <Tab.Container id="left-tabs-example" defaultActiveKey="first">
        <Row>
            ...
            <Nav variant="pills" className="flex-column">
              ...
              <Nav.Item>
                <Nav.Link className="chooseSidebar" eventKey="jobs">
                  <img src={jobs} className="icon-sidebar" alt="jobs-icon" />
                  Pekerjaan
                </Nav.Link>
              </Nav.Item>
              <Nav.Item>
              ...
              <Nav.Item>
                <Nav.Link className="chooseSidebar" eventKey="task">
                  <img src={task} className="icon-sidebar" alt="task-icon" />
                  Tugas
                </Nav.Link>
              </Nav.Item>
              <Nav.Item>
          ...
          <Col sm={9} className="overload-content">
            <Tab.Content>
